...
namespace Offset
{
    STATIC_OFFSET BuildingBlock = 0x2E53380;
    STATIC_OFFSET BaseNetworkable_c = 0x2E4D7B0;
    STATIC_OFFSET System_Collections_Generic_List_BaseGameMode_ = 0x2E896A0;
    STATIC_OFFSET MapMarker = 0x2EAA570;
    STATIC_OFFSET MainCamera = 0x2EA9870;
    STATIC_OFFSET TOD_Sky_c = 0x2E705B8;
    STATIC_OFFSET LocalPlayer = 0x2EA71D0;
    STATIC_OFFSET OcclusionCulling = 0x2EB9CA0;
    STATIC_OFFSET OutlineManager_c = 0x2EC5C40;
    STATIC_OFFSET EffectNetwork = 0x2E73988;
    STATIC_OFFSET LaserBeam = 0x2EA26D0;
    STATIC_OFFSET LaserLight = 0x2EA2798;
    STATIC_OFFSET BradleyAPC = 0x2E522A8;
    STATIC_OFFSET ConVar_Admin_c = 0x2ECA108;
    STATIC_OFFSET ConVar_Graphics = 0x2E817A8;
    STATIC_OFFSET ConVar_Culling = 0x2E633C0;
    STATIC_OFFSET ConVar_Debugging = 0x2E6AD78;
    STATIC_OFFSET UIInventory = 0x2E7CBD0;
    STATIC_OFFSET Buttons = 0x2E53A68;
    STATIC_OFFSET Network_Net = 0x2EB5F20;
    STATIC_OFFSET ConsoleSystem_Index = 0x2EA23F0;
